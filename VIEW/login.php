...
<div class="login-box">
    ...
    <form action="../CONTROLLER/loginController.php" method="post">
        ...
        <a>
            ...
            <span></span>
            <span></span>
            <button  class="signup-button">Entrar</button>
        </a>
...
background-color:rgb(0, 38, 143);
    ...
    .login-box a:hover {
        background:rgb(0, 19, 105);
        color: #fff;
        border-radius: 5px;
        box-shadow: 0 0 5pxrgb(18, 0, 122), 0 0 25pxrgb(10, 0, 102), 0 0 50px #03e9f4, 0 0 100px #03e9f4;
    }
    ...
    .login-box a span:nth-child(1) {
        ...
        width: 100%;
        height: 2px;
        background: linear-gradient(90deg, transparent,rgb(13, 0, 129));
...
// Adding event listeners to buttons and sidebar for the corresponding actions
    ...
    sidebarCloseBtn.addEventListener("click", toggleSidebar);</script> ç